	...
	public function insert()
	{
		//Auth::hasAccess('landing_pages.insert', $this->request->get_httpreferer());
			...
			if($this->request->is_post()) {
				...
				$data['title_en'] = $this->request->get_post('page_title_en');

				$data['friendlyurl_hu'] = $this->request->get_post('page_friendlyurl_hu');
				$data['friendlyurl_en'] = $this->request->get_post('page_friendlyurl_en');
