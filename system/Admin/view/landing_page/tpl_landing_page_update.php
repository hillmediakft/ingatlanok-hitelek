				...
				<div class="portlet">
                        ...
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <?php echo $page['title_hu'];?> - oldal szerkesztése
                            </div>
                            <div class="actions">
					    ...
					    <div class="portlet-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="tab_1_1">
                                    ...
                                    <div class="form-group">
                                        <label for="page_frendlyurl_">Url (csak ékezet nélküli kisbetűt, számot és kötőjelet tartalamzhat)</label> 
                                        <input type='text' name='page_friendlyurl_hu' class='form-control' value="<?php echo $page['friendlyurl_hu'] ?>" pattern="[\-a-z0-9]+" required>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="tab_1_2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type='text' name='page_title_en' class='form-control' value="<?php echo $page['title_en'] ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="page_frendlyurl_">Url</label> 
                                        <input type='text' name='page_friendlyurl_en' class='form-control' value="<?php echo $page['friendlyurl_en'] ?>">
                                    </div>
