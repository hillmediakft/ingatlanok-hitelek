        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                    ...
                    <div id="table-marker" data-marker="haz_allapot_belul" style="display: none;"></div> 
                    ...
                    <table class="table table-striped table-hover table-bordered" id="haz_allapot_belul">
                        <thead>
                            <tr class="heading">
                                ...
                                <th>
                                    ház állapota belül kategória megnevezése magyar
                                </th>
                                <th>
                                    ház állapota belül kategória megnevezése angol
                                </th>
                                <th></th>
                                <th></th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($haz_allapot_belul as $value) { ?>
                            <tr>
                                <td>
                                    <?php echo $value['haz_allapot_belul_id'];?>
                                </td>
                                <td>
                                    <?php echo $value['haz_allapot_belul_leiras_hu'];?>
                                </td>
                                <td>
                                    <?php echo $value['haz_allapot_belul_leiras_en'];?>
                                </td>
                                <td>
