                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="latitude" id="latitude" class="form-control" value="<?php echo $content['latitude']; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <!-- FÖLDRAJZI HOSSZÚSÁG -->
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="longitude" id="longitude" class="form-control" value="<?php echo $content['longitude']; ?>"/>
                                                    </div>
                                                </div>
                                            </div> 
