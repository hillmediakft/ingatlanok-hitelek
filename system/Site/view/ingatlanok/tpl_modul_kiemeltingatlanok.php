					...
					<div class="preview">
						<div style="overflow: hidden; width:85px; height:85px;">
							<?php if ($ingatlan['kepek']) { ?>
							    <img style="height:85px; width:auto;" src="<?php echo $this->url_helper->thumbPath($this->getConfig('ingatlan_photo.upload_path') . $photo_array[0]); ?>" alt="<?php echo $ingatlan['ingatlan_nev_' . LANG]; ?>">
							<?php } else { ?>
