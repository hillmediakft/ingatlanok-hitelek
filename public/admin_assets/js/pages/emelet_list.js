var Emelet = function () {
    ...
    var handleTable = function () {
        ...
        /*      var tableWrapper = $("#emelet_wrapper");
        ...
        table.on('click', '.delete', function (e) {
            ...
            bootbox.confirm("Biztosan törölni akarja?", function (result) {
                if (result) {
                    ...
                    var emeletId = $(reference.closest('tr')).find('td:first').html();
                    emeletId = $.trim(emeletId);
                    ...
                    if (result) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                table: 'ingatlan_emelet',
                                id_name: 'emelet_id',
                                leiras_name: 'emelet_leiras',
                                data: {"emelet_leiras_hu": data[0], "emelet_leiras_en": data[1]}
                            },
