...
/*
        var tableWrapper = $("#parkolas_wrapper");
        ...
        table.on('click', '.delete', function (e) {
            ...
            bootbox.confirm("Biztosan törölni akarja?", function (result) {
                if (result) {
                    ...
                    var parkolasId = $(reference.closest('tr')).find('td:first').html();
                    parkolasId = $.trim(parkolasId);
                    ...
                    if (result) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                table: 'ingatlan_parkolas',
                                id_name: 'parkolas_id',
                                leiras_name: 'parkolas_leiras',
                                data: {"parkolas_leiras_hu": data[0], "parkolas_leiras_en": data[1]}
                            },
