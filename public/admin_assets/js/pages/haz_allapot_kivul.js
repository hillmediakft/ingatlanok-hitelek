var Haz_allapot_kivul = function () {
...
/*
        var tableWrapper = $("#haz_allapot_kivul_wrapper");
...
*/
        ...
        $('#haz_allapot_kivul_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            bootbox.confirm("Biztosan törölni akarja?", function (result) {
                if (result) {
                    ...
                    var haz_allapot_kivulId = $(reference.closest('tr')).find('td:first').html();
                    haz_allapot_kivulId = $.trim(haz_allapot_kivulId);
                    
                    $.ajax({
                        type: "POST",
                        data: {
                            id: haz_allapot_kivulId,
                            action: 'delete',
                            table: 'ingatlan_haz_allapot_kivul',
                            id_name: 'haz_allapot_kivul_id'
                        },
                    ...
                    if (result) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                table: 'ingatlan_haz_allapot_kivul',
                                id_name: 'haz_allapot_kivul_id',
                                leiras_name: 'haz_allapot_kivul_leiras',
                                data: {"haz_allapot_kivul_leiras_hu": data[0], "haz_allapot_kivul_leiras_en": data[1]}
                            },
