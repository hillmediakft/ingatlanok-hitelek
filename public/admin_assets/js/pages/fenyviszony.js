...
/*
        var tableWrapper = $("#fenyviszony_wrapper");
...
*/
        ...
        $('#fenyviszony_new').click(function (e) {
            e.preventDefault();
        ...
        table.on('click', '.delete', function (e) {
            ...
            bootbox.confirm("Biztosan törölni akarja?", function (result) {
                if (result) {
                    ...
                    var fenyviszonyId = $(reference.closest('tr')).find('td:first').html();
                    fenyviszonyId = $.trim(fenyviszonyId);
                    ...
                    $.ajax({
                        ...
                        data: {
                            id: fenyviszonyId,
                            action: 'delete',
                            table: 'ingatlan_fenyviszony',
                            id_name: 'fenyviszony_id'
                        },
                    ...
                    if (result) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                table: 'ingatlan_fenyviszony',
                                id_name: 'fenyviszony_id',
                                leiras_name: 'fenyviszony_leiras',
                                data: {"fenyviszony_leiras_hu": data[0], "fenyviszony_leiras_en": data[1]}
                            },
