...
/*
        var tableWrapper = $("#komfort_wrapper");
        ...
        table.on('click', '.delete', function (e) {
            ...
            bootbox.confirm("Biztosan törölni akarja?", function (result) {
                if (result) {
                    ...
                    var komfortId = $(reference.closest('tr')).find('td:first').html();
                    komfortId = $.trim(komfortId);
                    ...
                    if (result) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                table: 'ingatlan_komfort',
                                id_name: 'komfort_id',
                                leiras_name: 'komfort_leiras',
                                data: {"komfort_leiras_hu": data[0], "komfort_leiras_en": data[1]}
                            },
