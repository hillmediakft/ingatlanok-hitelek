...
/*
        var tableWrapper = $("#futes_wrapper");
        ...
        table.on('click', '.delete', function (e) {
            ...
            bootbox.confirm("Biztosan törölni akarja?", function (result) {
                if (result) {
                    ...
                    var futesId = $(reference.closest('tr')).find('td:first').html();
                    futesId = $.trim(futesId);
                    ...
                    if (result) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                table: 'ingatlan_futes',
                                id_name: 'futes_id',
                                leiras_name: 'futes_leiras',
                                data: {"futes_leiras_hu": data[0], "futes_leiras_en": data[1]}
                            },
